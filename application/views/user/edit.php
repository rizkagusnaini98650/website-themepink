                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="form-group row">
                                <label for="hobi" class="col-sm-3 col-form-label">Picture</label>
                                <div class="col-sm-10">
                                    <div class="row">
                                        <div class="col-sm-16">
                            ...
                            <div class="btn-group btn-group-sm" style="margin-top: 40px;">
                                <button type="submit" class="btn btn-danger"><a class="nav-link" href="<?= base_url('user/edit') ?>">
